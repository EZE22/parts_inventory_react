...
class NikonUpdateComponent extends Component {
    constructor(props) {
        super(props)
        this.state = {
    ...
    onSubmit(values) {
        ...
        NikonDataService.updateNikonPart(part)
        .then(()=> this.props.history.push('/nikon'))
    }
...
export default NikonUpdateComponent